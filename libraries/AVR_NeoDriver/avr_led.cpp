...
AVRLED::AVRLED(uint8_t pin, uint8_t num_pixels, neoPixelType t)
    : Adafruit_NeoPixel(num_pixels, pin, t) {
...
void AVRLED::set_temp_color_target(uint8_t white, uint8_t red, uint8_t green,
                                   uint8_t blue) {
  uint32_t c = 0;
...
void AVRLED::set_base_color_target(uint8_t white, uint8_t red, uint8_t green,
                                   uint8_t blue) {
  uint32_t c = 0;
